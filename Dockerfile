...
COPY config/parameters.yml /var/www/
RUN git clone https://github.com/vtsykun/private-packagist.git /var/www/packagist && \
    mv /var/www/parameters.yml /var/www/packagist/app/config/parameters.yml && \
    composer install --no-interaction --no-suggest --prefer-dist --working-dir /var/www/packagist && \
    touch /var/www/packagist/lock.txt && chown www-data:www-data -R /var/www
